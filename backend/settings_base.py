...
PRERENDER_DESCRIPTION = (
    "InstiApp is the front page of all student activities at IIT Bombay"
)
...
if (
    "LDAP_USERNAME" in os.environ
    and "LDAP_PASSWORD" in os.environ
    and "SSO_TOTP_TOKEN" in os.environ
):
